            ...
            <table id="data-table" class="table table-bordered" cellspacing="0" width="100%">
                    <thead>
                        <tr class="active">
                            ...
                            <th class="text-center">คนยืม</th>
                            <th class="text-center">แก้ไข</th>
                            
                            <th class="text-center">คืนวัสดุ</th>
                        </tr>
                    </thead>
            <tbody>  
                        <?php
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-danger" href="delete/a1-del.php?id=<?=$row["id"]?>" role="button" onclick="return confirm('ท่านต้องการลบข้อมูลหรือไม่ !')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span>คืนวัสดุ</a>
                            </td>
                        </tr>
                        <?php
                            }
