                ...
                <div class="text-center">
                    <div class=" center"><h3>MENU</h3></div> 
                        <ul class="navLeft orengeLight ">
                            ...
                            <li><a href="b3_2.php" >ศูนย์คอมพิวเตอร์ ชั้นที่ 1</a></li>
                ...
                <table id="data-table" class="table table-bordered" cellspacing="0" width="100%">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a class="btn btn-warning" href="b1_edit.php?id=<?=$row["id"]?>" role="button"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>ลบ</a>
                            </td>
