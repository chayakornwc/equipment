...
<!---------------------------------------------------------- เนื้อหา -------------------------------------------------------->
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-9">
                <h3>ศูนย์คอมพิวเตอร์ LPRU ชั้นที่ 1</h3> 
                <div class="col-lg-3">
                    <a class="btn btn-success" href="b3_1_1.php" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> ห้อง  </a>   
                </div>
                <div class="col-lg-3">
                    <a class="btn btn-success" href="b3_1_1.php" role="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span> ห้อง </a>   
                </div>
