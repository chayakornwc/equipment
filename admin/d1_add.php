...
<!---------------------------------------------------------- เนื้อหา -------------------------------------------------------->
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <h3>เพิ่มข้อมูลบริษัท/ห้าง/ร้าน</h3>
                ...
                <form class="form-horizontal" method="post" action="insert/d1_int.php">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input name="company_name" placeholder="ชื่อ" type="text" class="form-control" required pattern="[ก-์]{a-z}" minlength="1" maxlength="50" title="กรุณากรอกข้อมูลเป็นภาษาไทยหรือภาษาอังกฤษ">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label">ที่อยู่</label> 
                        <div class="col-sm-6">
                            <input name="company_domicile" placeholder="ที่อยู่" type="text" class="form-control" required pattern="[ก-์]{a-z}[0-9]{0,10}" minlength="1" maxlength="50" title="กรุณากรอกข้อมูลเป็นภาษาไทยหรือภาษาอังกฤษ">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input name="company_phon" placeholder="เบอร์โทร" type="text" class="form-control" required pattern="[ก-์]{a-z}[0-9]{0,10}"  title="กรุณากรอกข้อมูล">
                        </div>
                    </div>
